...
public class ResponseBean<T> {
    ...
    public ResponseBean(long code, String message) {
        this.code = code;
        this.message = message;
        this.data = null;
    }
...
//    }
    ...
    public static ResponseBean fail(int code,String errmsg) {
        return new ResponseBean(code,errmsg);
    }


    public static ResponseBean fail(String errmsg) {
        return new ResponseBean(-1,errmsg);
    }
