...
public class ResponseUtil<T> {
    ...
    public ResponseUtil(long code, String message, T data) {
        this.code = code;
    ...
    public static <T> ResponseUtil<T> success(T data) {
        return new ResponseUtil<T>(ResultCode.SUCCESS.getCode(), ResultCode.SUCCESS.getMessage(), data);
    }
...
//    }
    ...
    public static <T> ResponseUtil<T> unauthorized(T data) {
        return new ResponseUtil<T>(ResultCode.UNAUTHORIZED.getCode(), ResultCode.UNAUTHORIZED.getMessage(), data);
    }
