...
public class LsAdminPermissionRelation {
    /**
     *
     ...
     * @mbg.generated
     */
    public LsAdminPermissionRelation(Long id, Long adminId, Long permissionId, Integer type) {
        this.id = id;
     ...
     * @mbg.generated
     */
    public LsAdminPermissionRelation() {
        super();
    }
