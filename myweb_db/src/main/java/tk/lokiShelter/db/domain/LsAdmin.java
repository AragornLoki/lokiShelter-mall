...
public class LsAdmin {
     ...
     * @mbg.generated
     */
    public LsAdmin(Long id, String username, String password, String icon, String email, String nickName, String note, Date createTime, Date loginTime, Integer status) {
        this.id = id;
